// @ts-check -- https://github.com/microsoft/TypeScript/issues/58262
...
import braidPlugin from "./plugin.js";
...
const javaScriptRules = {
	"@braidai/no-mixed-export": "warn",
	"@braidai/no-uncalled-iife-in-promise-all": "warn",
...
/** @type {RulesRecord} */
const typeScriptDeclarationRules = {
	// Great for group types (and only types!)
	"@typescript-eslint/no-namespace": "off",
	// That the variables are used is the whole point of an ambient declaration
	"@typescript-eslint/no-unused-vars": "off",
	// Interface as class technique
...
export default [
	...
	// Settings
	{
		...
		plugins: {
			"@stylistic": /** @type {Plugin}*/(stylisticPlugin),
			"@braidai": braidPlugin,
	...
	// TypeScript settings
	{
		files: tsGlob,
		plugins: {
			"@typescript-eslint": /** @type {Plugin}*//** @type {any}*/(typeScriptPlugin),
		},
		languageOptions: {
